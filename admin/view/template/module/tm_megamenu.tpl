                                        ...
                                        <div id="collapse<?php echo $i; ?>" class="panel-collapse collapse"
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group required">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="menu_item[<?php echo $i; ?>][type]" id="input-menu-item-type_<?php echo $i; ?>"  class="form-control">
                                                                <option value="1" selected="selected"><?php echo $text_type_custom; ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <input
                                                ...
                                                value="<?php echo isset($menu_item[$i][$language['language_id']]['title']) ? $menu_item[$i][$language['language_id']]['title'] : ''; ?>"/>
													...
													<div class="form-group">
                                                        <label class="col-sm-2 control-label"
                                                               for="input-menu-item-sort-order_<?php echo $i; ?>">Sort Order</label>

                                                        <div class="col-sm-10">
														<input type="text" name="menu_item[<?php echo $i; ?>][sort_order]" value="<?php if (isset($menu_item[$i]['sort_order'])) echo $menu_item[$i]['sort_order']?>" class="form-control">
                                                        </div>
                                                    </div>
