			...
			<?php } ?>
				<div class="product-thumb transition <?php if ($product['options']) echo 'options';?>">
					...
					<div class="product__buttons">
						...
						<a class="product-btn quickview" data-rel="details" data-toggle="tooltip" title="<?php echo $text_quick; ?>" href="#quickview_bestsellers_<?php echo $b . $module ?>"><i class="fa fa-eye"></i></a>
					</div>
