						...
						<div class="mfilter-opts-container">
							<div class="mfilter-content-wrapper">
								<div class="mfilter-options">
									<?php if( $filter['type'] == 'search' || $filter['type'] == 'search_oc' ) { ?>
...
<script type="text/javascript">
	TMFilterLang.text_display = '<?php echo $text_display; ?>';
	TMFilterLang.text_list	= '<?php echo $text_list; ?>';
	TMFilterLang.text_grid	= '<?php echo $text_grid; ?>';
	TMFilterLang.text_select	= '<?php echo $text_select; ?>';
		...
		jQuery('#mfilter-box-<?php echo (int) $_idx; ?>').each(function(){
			...
			TMFilterINSTANCES.push((new TMFilter()).init( _t, {
				...
				'displayListOfItems'	: {
					...
					'maxHeight'			: <?php echo empty( $settings['display_list_of_items']['max_height'] ) ? 206 : (int) $settings['display_list_of_items']['max_height']; ?>,
