...
<div class="container">
	...
	<div class="row">
		...
		<div id="content" class="<?php echo $class; ?>">
			...
			<h1><i class="fl-line-icon-set-grocery10"></i><?php echo $heading_title; ?>
				<?php if ($weight) { ?>
				&nbsp;(<?php echo $weight; ?>)
				<?php } ?>
			</h1>
			...
			<div class="cart-wrapper">
						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-left"><?php if(is_array($product['daymeals']) && sizeof($product['daymeals'])>0){ ?>
									...
									<td class="text-center" style="width: 0">
										<button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="product-btn" onclick="cart.remove('<?php echo $product['cart_id']; ?>');">
				...
				<div class="buttons">
					...
					<div class="pull-right">
						<a href="<?php echo $checkout; ?>" class="btn btn-primary checkout"> <span><?php echo $button_checkout; ?></span> </a>
					</div>
				</div>
			</div>
