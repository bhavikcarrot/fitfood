    ...
    <div class="container">
        ...
        <div class="row"><?php echo $column_left; ?>
            ...
            <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
                <h1 class="no-line"><i class="fa fa-exchange"></i><?php echo $heading_title; ?></h1>
                <?php if ($products) { ?>
                    <div class="table-responsive">
                        <table class="table table-bordered">
                                    ...
                                    <td class="text-center">
                                        <div class="product-thumb">
                                            <a href="<?php echo $product['remove']; ?>" data-toggle="tooltip"
                                               ...
                                               class="product-btn fa fa-trash-o"></a>
                                            ...
                                            <?php if ($review_status) { ?>
                                                ...
                                                <div class="rating">
                                                    <?php for ($i = 1; $i <= 5; $i++) { ?>
                                                        ...
                                                        <?php } else { ?>
                                                            <span class="fa-stack"><i class="fa fa-star"></i></span>
                                                        <?php } ?>
                                                    <?php } ?>
                                                    <div class="review"> <?php echo $products[$product['product_id']]['reviews']; ?></div>
                                                </div>
												<?php } ?>
                                            <?php } ?>
                                        </div>
                            ...
                            <tr>
                                ...
                                <?php foreach ($products as $product) { ?>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-primary" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fl-line-icon-set-grocery10"></i> <span><?php echo $button_cart; ?></span></button>
                                    </td>
                                <?php } ?>
                            </tr>
                        </table>
