    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <?php } ?>
		<a href="index.php?route=product/7days/getProduct&product_id=51" rel="facebox">Custom Meal</a>
        <a href="index.php?route=product/7days/getCategory&category=20" rel="facebox">Signature Entries</a>
		  <?php
		// var_dump($catlist);
		foreach ($catlist as $catlist) { 
		if($catlist['category_id']=='59')
		{
		echo "<a href='javascript:void(0)'  id='btn_click'>".$catlist['name']."</a><br>";
	}
	else
	{
	echo $catlist['name']."<br>";
	}
		}
		?>
...
$(document).ready(function() {
	...
	/*$('input name=["option[42]"]').on('change',function(){
...
var days = [
	...
	$(document).on('click',".day",function(){
		...
		$("#weekdayPlanner").remove();
			...
			//var d= parseInt($(this).val().substr(8));
			//console.log(d);
			for(var i=1;i<=7;i++){
				//var x = d.getDay()+i;
				var x = d+i-1;
