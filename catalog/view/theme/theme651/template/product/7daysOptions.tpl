...
<div id="div-<?php echo $product_id; ?>">
  <?php if ($options) { ?>
  ...
  <input type="hidden" name="meal_type" value="<?=$meal_type?>" /><input type="hidden" name="meal_days" value="<?=$meal_days?>" />
    ...
    <br />
    <button type="button" id="product-<?php echo $product_id; ?>" data-loading-text="Loading..<?php //echo $text_loading; ?>" class="button btn btn-primary  7days-addCart">Add this<?php //echo $button_cart; ?></button>
  </div>
</div>