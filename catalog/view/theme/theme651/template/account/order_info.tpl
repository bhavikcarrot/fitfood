        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right price-tx"><?php echo $product['price']; ?></td>
              <td class="text-right price-tx"><?php echo $product['total']; ?></td>
              <td class="text-right" style="white-space: nowrap;"><?php if ($product['reorder']) { ?>
                <a href="<?php echo $product['reorder']; ?>" data-toggle="tooltip" title="<?php echo $button_reorder; ?>" class="product-btn btn-add"><i class="fl-line-icon-set-grocery10"></i></a>
                <?php } ?>
                <a href="<?php echo $product['return']; ?>" data-toggle="tooltip" title="<?php echo $button_return; ?>" class="product-btn"><i class="fa fa-undo"></i></a></td>
            </tr>
            <?php } ?>
          ...
          <tfoot>
            ...
            <tr>
              ...
              <td class="text-right price-tx"><?php echo $total['text']; ?></td>
              <?php if ($products) { ?>
              <td></td>
              <?php } ?>
            </tr>
