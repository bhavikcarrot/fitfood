...
<div class="container">
    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            <h1 class="no-line"><i class="fa fa-heart-o"></i><?php echo $heading_title; ?></h1>
                            ...
                            <?php foreach ($products as $product) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');" title="<?php echo $button_cart; ?>" class="btn btn-primary"><i class="fl-line-icon-set-grocery10"></i> <span><?php echo $button_cart; ?></span> </button>
                                    </td>

                                    <td class="text-center" style="width: 0">
                                        <a href="<?php echo $product['remove']; ?>" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="product-btn"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
