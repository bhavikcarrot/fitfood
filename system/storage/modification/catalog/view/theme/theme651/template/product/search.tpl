                            ...
                            <div class="product-options form-horizontal">
                                <div class="options">
									...
									<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i>
                                        ...
                                        <?php } ?>
                                    <?php } ?>
                                    <button class="btn btn-primary" type="button" onclick="cart.addPopup($(this),'<?php echo $product['product_id']; ?>');"><i class="fl-line-icon-set-grocery10"></i> <span><?php echo $button_cart; ?></span></span>
                                    </button>
                                </div>
                            </div>
                        </div>
	...
	<?php } ?>
			...
			<div class="product__buttons">
                ...
                <div class="aside">
					...
					<div class="cart-button">
                		<button class="btn btn-primary" type="button" onclick="ajaxAdd($(this),<?php echo $product['product_id'] ?>);"><i class="fl-line-icon-set-grocery10"></i> <span><?php echo $button_cart; ?></span></button>
						<div class="clear"></div>                		
