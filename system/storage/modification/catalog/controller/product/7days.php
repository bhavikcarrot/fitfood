<?php
class ControllerProduct7days extends Controller {
private $error = array();
...
$data['catlist'] = $this->model_catalog_category->getCategory('1');
			$this->response->setOutput($this->load->view('product/product_7days', $data));
		} else {
			$url = '';
			...
			$data['footer'] = $this->load->controller('common/footer');
			$data['header'] = $this->load->controller('common/header');
			if($result['product_id']==54)
			$data['meal_type']=2;
			else if($result['product_id']==55)
			$data['meal_type']=3;
			else
			$data['meal_type']=1;
	...
	public function getProduct() {
		$data['meal_type'] = $this->request->get['mealType'];
		$data['meal_days'] = $this->request->get['mealDay'];
		$data['meal'] = $this->request->get['meal'];
		$this->load->model('tool/image');
		...
		$data['options'] = array();
			...
			$this->response->setOutput($this->load->view('product/7daysOptions', $data));
	}
	...
	function getCategory(){
		...
		$this->response->setOutput($this->load->view('product/7daysCategory', $data));
	}
}
